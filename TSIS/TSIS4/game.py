...
food_sound = pygame.mixer.Sound("sounds/music_food.mp3")
gameover_sound = pygame.mixer.Sound("sounds/music_gameover.mp3")
move_sound = pygame.mixer.Sound("sounds/music_move.mp3")
